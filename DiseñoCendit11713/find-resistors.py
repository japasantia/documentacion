...
_resValues = [
  ...
  200.0, 220.0, 240.0, 270.0, 300.0, 330.0, 360.0, 
  390.0, 430.0, 470.0, 510.0, 560.0, 620.0, 680.0, 
  750.0, 820.0, 910.0
]
...
for R1 in resValues:  
  for R2 in resValues:      
    error = abs(R2 * (1 + tol) / (R1 * (1 - tol)) - obj)
    if  error < minError:
      minError = error
      seekR1 = R1
      seekR2 = R2

print("R1 = %f, R2 = %f" % (seekR1, seekR2))
print("Vo = %f" % ( vref * (1 + seekR2 / seekR1)))     
