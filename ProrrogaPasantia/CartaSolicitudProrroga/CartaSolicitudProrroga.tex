...
\begin{document}
	...
	\begin{enumerate}
		...
		%\item Recopilar la documentación y software asociado al sistema de medición de ﬁgura de ruido (SMFR).		
	...
	Como anexo, en las siguientes tablas se indican las actividades ejecutadas hasta el día 20 de octubre de 2017. En éstas se indica la fase a la cual pertenece, la actividad y el porcentaje de culminación respectivo.
	...
	\begin{table}[h!]
		\begin{tabularx}{\textwidth}{p{0.15\textwidth}p{0.6\textwidth}c}
			...
			& Elaboración de informe técnico descriptivo del SMFR.		 Investigación y recopilación de las partes del software asociado al SMFR. \\
			\bottomrule		
		\end{tabularx}
